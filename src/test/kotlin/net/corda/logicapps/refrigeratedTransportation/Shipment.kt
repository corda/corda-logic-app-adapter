...
data class Shipment(
    ...
    constructor(
        ...
        initiatingCounterparty = owner,
        owner = owner,
        counterparty = owner,
        previousCounterparty = null,
        device = device,
        ...
        complianceSensorType = null,
        complianceSensorReading = null,
        complianceStatus = true,
        complianceDetail = null,
        lastSensorUpdateTimestamp = null,
        linearId = linearId
    )

    override val participants: List<Party> get() = buildParticipants()

    fun recordTelemtery(humidity: Int, temperature: Int): Shipment {
        ...
        return copy(lastSensorUpdateTimestamp = timestamp)
    }
